...
public interface CampaignLocalService extends BaseLocalService,
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public java.lang.String getCampaignDescription(Campaign campaign,
		Locale locale);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public java.lang.String getCampaignName(Campaign campaign, Locale locale);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Map<Locale, java.lang.String> getDescriptionMap(Campaign campaign);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Map<Locale, java.lang.String> getNameMap(Campaign campaign);
