...
public class CampaignUtil {
	...
	* @throws NoSuchCampaignException if a matching campaign could not be found
	*/
	public static Campaign findByG_C(long groupId, long campaignId)
		throws com.liferay.campaign.manager.exception.NoSuchCampaignException {
	...
	* @return the matching campaign, or <code>null</code> if a matching campaign could not be found
	*/
	public static Campaign fetchByG_C(long groupId, long campaignId) {
		return getPersistence().fetchByG_C(groupId, campaignId);
	}
	...
	*/
	public static Campaign fetchByG_C(long groupId, long campaignId,
		boolean retrieveFromCache) {
		return getPersistence()
				   .fetchByG_C(groupId, campaignId, retrieveFromCache);
	}
	...
	* @return the campaign that was removed
	*/
	public static Campaign removeByG_C(long groupId, long campaignId)
		throws com.liferay.campaign.manager.exception.NoSuchCampaignException {
		return getPersistence().removeByG_C(groupId, campaignId);
	}
