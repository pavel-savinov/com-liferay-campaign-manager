...
public class CampaignLocalizationModelImpl extends BaseModelImpl<CampaignLocalization>
	...
	public static final String TABLE_SQL_CREATE = "create table CampaignLocalization (campaignLocalizationId LONG not null primary key,companyId LONG,groupId LONG,campaignId LONG,name VARCHAR(140) null,description VARCHAR(340) null,languageId VARCHAR(75) null)";
	...
	public static final long CAMPAIGNLOCALIZATIONID_COLUMN_BITMASK = 8L;
	...
	public Object clone() {
		...
		campaignLocalizationImpl.setCompanyId(getCompanyId());
		campaignLocalizationImpl.setGroupId(getGroupId());
	...
	public void resetOriginalValues() {
		...
		campaignLocalizationModelImpl._originalGroupId = campaignLocalizationModelImpl._groupId;

		campaignLocalizationModelImpl._setOriginalGroupId = false;
	...
	public CacheModel<CampaignLocalization> toCacheModel() {
		...
		campaignLocalizationCacheModel.companyId = getCompanyId();

		campaignLocalizationCacheModel.groupId = getGroupId();
